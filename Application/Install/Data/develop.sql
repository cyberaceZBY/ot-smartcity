...
VALUES
	(110, 'announcement', '通知公告', 100, 1, 10, '', '', '', '', '', '', '', '1200', '3', 0, 1, 1, 1, 0, '', '', 1439023485, 1439023485, 1, 0),
	...
	(320, 'field_news', '行业资讯', 300, 2, 10, '', '', '', '', '', '', '', '1200', '1', 0, 1, 1, 1, 0, '', '', 1420612697, 1420612808, 1, 0),
	(400, 'creative', '创新研究', 0, 4, 10, '', '', '', '', '', '', '', '1200', '1', 0, 1, 1, 1, 0, '', '', 1420612697, 1420612808, 1, 0),
	(500, 'team', '师资团队', 0, 5, 10, '', '', '', '', '', '', '', '1200', '1', 0, 1, 1, 1, 0, '', '', 1420612697, 1420612808, 1, 0),
...
-- ) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
--
-- INSERT INTO `model` VALUES (1300,'comment','用户心得',0,'',1,'{\"1\":[\"1301\",\"1302\",\"1303\",\"1304\",\"1305\"]}','1:基础','','','','','id:编号\r\nname:用户名字\r\njob:职业\r\nimage:图片\r\ndescription:描述\r\nlevel:排序',10,'','',1420438352,1424018624,1,'MyISAM');
--
-- INSERT INTO `attribute` VALUES
...
--   (1304,'description','描述','text NOT NULL','textarea','','',1,'',1300,1,1,1424018241,1424018241,'',3,'','regex','',3,'function'),
